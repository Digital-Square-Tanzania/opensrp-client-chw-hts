...
import org.smartregister.chw.hts.BuildConfig;
import org.smartregister.chw.hts.application.SampleApplication;
...
public class SampleRepository extends Repository {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        HtsLibrary.getInstance().visitRepository().createTable(database);
        HtsLibrary.getInstance().visitDetailsRepository().createTable(database);
