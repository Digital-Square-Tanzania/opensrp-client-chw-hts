...
@PrepareForTest(BaseHtsCallDialogFragment.class)
public class BaseHtsCallDialogFragmentTest {
    @Spy
    public BaseHtsCallDialogFragment baseTestCallDialogFragment;
    ...
    public void setUp() {
        ...
        Whitebox.setInternalState(BaseHtsCallDialogFragment.class, "MEMBER_OBJECT", htsMemberObject);
    }
    ...
    public void setCallTitle() throws Exception {
        ...
        Whitebox.invokeMethod(baseTestCallDialogFragment, "setCallTitle", viewGroup, view.getId(), "message");
        Assert.assertEquals("message Hts Client", textView.getText());
    }
