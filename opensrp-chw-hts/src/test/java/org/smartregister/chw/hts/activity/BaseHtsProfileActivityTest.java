...
public class BaseHtsProfileActivityTest {
    @Mock
    public BaseHtsProfileActivity baseTestProfileActivity;

    @Mock
    public HtsProfileContract.Presenter profilePresenter;
    ...
    public void formatTime() {
        BaseHtsProfileActivity activity = new BaseTestHtsProfileActivity();
        try {
    ...
    public void onClickBackPressed() {
        baseTestProfileActivity = Mockito.spy(new BaseTestHtsProfileActivity());
