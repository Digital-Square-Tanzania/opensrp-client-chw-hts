...
public class HtsMedicalHistoryActionHelper implements BaseHtsVisitAction.HtsVisitActionHelper {
    ...
    public HtsMedicalHistoryActionHelper(Context context, MemberObject memberObject) {
