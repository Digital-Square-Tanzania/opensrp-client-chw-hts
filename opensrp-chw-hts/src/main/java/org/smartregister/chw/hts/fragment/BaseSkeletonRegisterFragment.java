...
import org.smartregister.chw.hts.contract.SkeletonRegisterFragmentContract;
import org.smartregister.chw.hts.model.BaseSkeletonRegisterFragmentModel;
import org.smartregister.chw.hts.presenter.BaseSkeletonRegisterFragmentPresenter;
import org.smartregister.chw.hts.provider.SkeletonRegisterProvider;
...
public class BaseSkeletonRegisterFragment extends BaseRegisterFragment implements SkeletonRegisterFragmentContract.View {
    ...
    public void initializeAdapter(Set<View> visibleColumns) {
        SkeletonRegisterProvider htsRegisterProvider = new SkeletonRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
    ...
    public void setupViews(android.view.View view) {
        ...
        if (titleView != null) {
            ...
            titleView.setText(getString(R.string.hts));
