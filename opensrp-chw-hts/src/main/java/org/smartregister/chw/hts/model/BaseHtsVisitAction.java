...
import org.smartregister.chw.hts.fragment.BaseHtsVisitFragment;
 ...
 */
public class BaseHtsVisitAction {
    ...
    private BaseHtsVisitFragment destinationFragment;
    private String formName;
    private String jsonPayload;
    private String selectedOption;
    private HtsVisitActionHelper htsVisitActionHelper;
    private Map<String, List<VisitDetail>> details;
    private Context context;
    private Validator validator;

    private BaseHtsVisitAction(Builder builder) throws ValidationException {
        ...
        this.htsVisitActionHelper = builder.htsVisitActionHelper;
        ...
        try {
            if (StringUtils.isBlank(jsonPayload) && StringUtils.isNotBlank(formName)) {
                ...
                if (details != null && details.size() > 0) {
                    HtsJsonFormUtils.populateForm(jsonObject, details);
                }

                jsonPayload = jsonObject.toString();
            }

            if (htsVisitActionHelper != null) {
                htsVisitActionHelper.onJsonFormLoaded(jsonPayload, context, details);
                String pre_processed = htsVisitActionHelper.getPreProcessed();
                ...
                String sub_title = htsVisitActionHelper.getPreProcessedSubTitle();
                if (StringUtils.isNotBlank(sub_title)) {
                    this.subTitle = sub_title;
                }

                ScheduleStatus status = htsVisitActionHelper.getPreProcessedStatus();
                if (status != null) {
    ...
    private void onPayloadReceivedNotifyHelper(String jsonPayload) {
        ...
        htsVisitActionHelper.onPayloadReceived(jsonPayload);

        String sub_title = htsVisitActionHelper.evaluateSubTitle();
        if (sub_title != null) {
            setSubTitle(sub_title);
        }

        String post_process = htsVisitActionHelper.postProcess(jsonPayload);
        if (post_process != null) {
            this.jsonPayload = htsVisitActionHelper.postProcess(jsonPayload);
        }

        htsVisitActionHelper.onPayloadReceived(this);
    }
    ...
    public BaseHtsVisitFragment getDestinationFragment() {
        return destinationFragment;
    }

    public void setDestinationFragment(BaseHtsVisitFragment destinationFragment) {
    ...
    public HtsVisitActionHelper getHtsVisitActionHelper() {
        return htsVisitActionHelper;
    }

    public void setHtsVisitActionHelper(HtsVisitActionHelper htsVisitActionHelper) {
        this.htsVisitActionHelper = htsVisitActionHelper;
    }
    ...
    public void evaluateStatus() {
        ...
        if (getHtsVisitActionHelper() != null) {
            setActionStatus(getHtsVisitActionHelper().evaluateStatusOnPayload());
        }
    }
    ...
    public interface HtsVisitActionHelper {
         ...
         */
        void onPayloadReceived(BaseHtsVisitAction htsVisitAction);
    }
    ...
    public static class Builder {
        ...
        public Builder withDestinationFragment(BaseHtsVisitFragment destinationFragment) {
            this.destinationFragment = destinationFragment;
            return this;
        }
        ...
        public Builder withHelper(HtsVisitActionHelper htsVisitActionHelper) {
            this.htsVisitActionHelper = htsVisitActionHelper;
            return this;
        }
        ...
        public BaseHtsVisitAction build() throws ValidationException {
            return new BaseHtsVisitAction(this);
        }
    }
