...
import org.smartregister.chw.hts.custom_views.BaseSkeletonFloatingMenu;
import org.smartregister.chw.hts.dao.SkeletonDao;
import org.smartregister.chw.hts.domain.MemberObject;
import org.smartregister.chw.hts.domain.Visit;
import org.smartregister.chw.hts.interactor.BaseSkeletonProfileInteractor;
import org.smartregister.chw.hts.presenter.BaseSkeletonProfilePresenter;
import org.smartregister.chw.hts.util.Constants;
import org.smartregister.chw.hts.util.SkeletonUtil;
import org.smartregister.chw.hts.util.SkeletonVisitsUtil;
...
public abstract class BaseSkeletonProfileActivity extends BaseProfileActivity implements SkeletonProfileContract.View, SkeletonProfileContract.InteractorCallBack {
    ...
    protected void onCreation() {
        ...
        textViewRecordSkeleton = findViewById(R.id.textview_record_hts);
        textViewContinueSkeleton = findViewById(R.id.textview_continue);
        textViewContinueSkeletonService = findViewById(R.id.continue_hts_service);
    ...
    protected Visit getServiceVisit() {
        return HtsLibrary.getInstance().visitRepository().getLatestVisit(memberObject.getBaseEntityId(), Constants.EVENT_TYPE.SKELETON_SERVICES);
    }
    ...
    public void setProfileViewWithData() {
        ...
        if (memberObject.getSkeletonTestDate() != null) {
            textview_positive_date.setText(getString(R.string.hts_positive) + " " + formatTime(memberObject.getSkeletonTestDate()));
        }
    }
