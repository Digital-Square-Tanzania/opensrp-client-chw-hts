...
public class BaseHtsRegisterFragment extends BaseRegisterFragment implements HtsRegisterFragmentContract.View {
    ...
    @Override
    public HtsRegisterFragmentContract.Presenter presenter() {
        return (HtsRegisterFragmentContract.Presenter) presenter;
    }
    ...
    protected void initializePresenter() {
        ...
        presenter = new BaseHtsRegisterFragmentPresenter(this, new BaseHtsRegisterFragmentModel(), null);
    }
